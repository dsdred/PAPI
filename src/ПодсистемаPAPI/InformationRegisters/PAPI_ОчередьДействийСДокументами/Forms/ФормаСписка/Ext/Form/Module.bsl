...
Процедура ВыполнитьДействие(Команда)
	...
	Если ТекущиеДанные <> Неопределено Тогда 
		...
		ВыполнитьДействиеНаСервере(СтруктураРегистра); 
...
&НаСервере
Процедура ВыполнитьДействиеНаСервере(СтруктураРегистра)
	
	Если Не СтруктураРегистра.Выполнено Тогда 
...
Функция ПолучитьСтруктуруПоУмолчанию()
	...
	Возврат РегистрыСведений.PAPI_ОчередьДействийСДокументами.ПолучитьСтруктуруПоУмолчанию();	
