...
// Прочитать настройки сервисов интеграций ВJSON
// 
...
// Записать настройки сервисов интеграций из JSON
//
// Параметры:
...
// Установить текущие значения строки
//
// Параметры:
