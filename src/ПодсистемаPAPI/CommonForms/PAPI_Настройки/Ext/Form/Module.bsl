...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)  
	...
	Элементы.РасписаниеОбработкиПослеЗаписиВерсий.Заголовок = ТекущееРасписание("PAPI_ИсторияДанныхВыполнитьОбработкуПослеЗаписиВерсий");
	АвтоматическиОбрабатыватьПослеЗаписиВерсий = РегламентВключен("PAPI_ИсторияДанныхВыполнитьОбработкуПослеЗаписиВерсий");
...
&НаКлиенте
Процедура АвтоматическиОбрабатыватьПослеЗаписиВерсийПриИзменении(Элемент)

	УстановитьПараметрРегламентногоЗадания("Использование", АвтоматическиОбрабатыватьПослеЗаписиВерсий, "PAPI_ИсторияДанныхВыполнитьОбработкуПослеЗаписиВерсий");
	Элементы.РасписаниеОбработкиПослеЗаписиВерсий.Доступность = АвтоматическиОбрабатыватьПослеЗаписиВерсий;
	Элементы.НастроитьРасписаниеОбработкиПослеЗаписи.Доступность = АвтоматическиОбрабатыватьПослеЗаписиВерсий;

КонецПроцедуры

&НаКлиенте
Процедура НастроитьРасписаниеОбработкиПослеЗаписи(Команда)
	
	ДиалогРасписания = Новый ДиалогРасписанияРегламентногоЗадания(ТекущееРасписание("PAPI_ИсторияДанныхВыполнитьОбработкуПослеЗаписиВерсий"));
	ДопПараметр = Новый Структура("ИмяРегламентногоЗадания,ЭлементРасписания", "PAPI_ИсторияДанныхВыполнитьОбработкуПослеЗаписиВерсий", "РасписаниеОбработкиПослеЗаписиВерсий");
	ОписаниеОповещения = Новый ОписаниеОповещения("НастроитьРасписаниеЗавершение", ЭтотОбъект, ДопПараметр);
	ДиалогРасписания.Показать(ОписаниеОповещения);
...
&НаКлиенте
Процедура ВыполнитьОбработкуПослеЗаписиВерсий(Команда)
	ВыполнитьОбработкуПослеЗаписиВерсийНаСервере();
КонецПроцедуры  

&НаСервере
Процедура ВыполнитьОбработкуПослеЗаписиВерсийНаСервере()
	PAPI_ИсторияДанных.ВыполнитьОбработкуПослеЗаписиВерсийНаСервере();
КонецПроцедуры
